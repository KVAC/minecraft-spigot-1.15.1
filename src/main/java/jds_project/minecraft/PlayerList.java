...
public class PlayerList {
	 ...
	 * 
	 * @param index - the index of the entry in the tablist
	 * 
	 * @return
	 */
...
class Skin implements ConfigurationSerializable {
	 ...
	 * @param base64       the base64 data of the skin, as returned by Mojang's
	 *                     servers.
	 * @param signedBase64 the signed data of the skin, as returned by Mojang's
	 *                     servers.
	 */
